package com.main.EventCreation.EventReport;
...
public class EventReport {
    ...
    public void generateEventReport(List<Map<String, String>> allAttendanceData) {

        try {
            // Load JR XML template
            String reportTemplatePath = "src/main/resources/com/main/EventReport/EventsReport.jrxml";
            JasperReport jasperReport = JasperCompileManager.compileReport(reportTemplatePath);

            // Fill the report with data
            Map<String, Object> parameters = new HashMap<>();
            // parameters
            parameters.put("ReportTitle", "Events Report");
