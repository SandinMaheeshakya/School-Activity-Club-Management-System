...
public class AdvisorReport {
    ...
    public void generateAdvisorReport(List<Map<String, String>> allAttendanceData) {
        try {
            // Load JR XML template

            String reportTemplatePath = "src/main/resources/com/main/registrationProcess/Reports/ClubAdvisorsReport.jrxml";
            JasperReport jasperReport = JasperCompileManager.compileReport(reportTemplatePath);

            // Fill the report with data
            Map<String, Object> parameters = new HashMap<>();
            // parameters
            parameters.put("ReportTitle", "Advisor Report");
